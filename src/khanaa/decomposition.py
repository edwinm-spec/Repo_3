...
def spelling_decompose(text: str) -> Union[Dict[str, Any], None]:
    """Decompose Thai word into its spelling components.
    
    Args:
        text: Thai syllable/word
        
    Returns:
        Dictionary with data, detail, and pref keys, or None if cannot decompose
    """
    global vowel_re
    if vowel_re is None:
    ...
    try:
        ...
        # Step 5: Remove tone mark for onset analysis
        no_tone = remove_tone(no_coda)
        
        # Step 6: Find silent before
